...
export const FIND_CARE_FLOW_ELEMENTS = [
  ...
  text("fc-lbl-pref", "Provider preferences (related)", 60, 870, 300, 24, 12, DIM),
  img("fc-preferences", "/canvas-flow/preferences.png", 60, 900, SCREEN_W, SCREEN_H, 10),
  arrow("fc-arr-care-pref", 210, 715, 210, 900, "rgba(124,106,247,0.5)"),
  text("fc-lbl-care-pref", "Manage care preferences", 230, 790, 220, 20, 11, DIM),
  ...
  text("fc-lbl-care-cancel", "[View Appointment] → [Cancel]", 365, 425, 130, 40, 10, DIM),
  ...
  text("fc-lbl-care-reschedule", "[Reschedule Appointment]", 365, 700, 130, 40, 10, DIM),
  ...
  text("fc-lbl-confirm-reschedule", "[Confirm Reschedule]", 1645, 892, 140, 20, 11, DIM),
  ...
  text("fc-lbl-error", "Error: system failure", 390, 1075, 180, 32, 10, DIM),
  ...
  text("fc-lbl-no-slots", "No slots in range", 770, 1075, 170, 32, 10, DIM),
